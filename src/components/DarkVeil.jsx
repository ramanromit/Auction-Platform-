...
export default function DarkVeil({
  ...
  // Use refs to store latest prop values to avoid re-creating the effect
  ...
  useEffect(() => {
    ...
    // Initial values
    let currentHue = propsRef.current.hueShift;
    ...
    const loop = () => {
      ...
      program.uniforms.uHueShift.value = currentHue;
  ...
  }, [resolutionScale]); // Only re-run if resolutionScale changes
